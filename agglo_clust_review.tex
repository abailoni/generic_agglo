...
\newcommand*{\cost}{\omega}%
\newcommand*{\interact}{\mathcal{W}}
\newcommand*{\algname}{GALSGAC}
...
%%%%%%%%% TITLE
\title{Generalized Framework for \\Agglomerative Clustering of Signed Graphs \\applied to proposal-free instance segmentation}
