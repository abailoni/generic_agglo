...
\item (Felzenszwalb Efficient Graph-based Image segmentation: can be included, but probably better to just mention it in the related work)
\end{itemize}
\end{itemize}
