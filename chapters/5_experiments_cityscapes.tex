...
Min &  0.000    & 0.000  \\
    ...
    \end{subtable} 
    \caption{AP scores on the cityscapes validation set for UGACA and different types of update rules. \TODO{PROBLEM: all apart from GMIS uses finetuned affinities... Unfair comparison?} }
