...
\begin{minipage}[T]{0.35\textwidth}
    ...
    \footnotesize
        \begin{tabular}{l|c|c}
          ...
          Min + CLC & 0.00 & 0.50 \\
        \end{tabular}
    \captionof{table}{Average Precision (AP) scores achieved by different versions of \algname{} and chosen bias parameters $\beta$ on the cityscapes validation set. A bias value $\beta=0$ returns one single cluster.}
