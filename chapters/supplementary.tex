...
The same reasoning can also be applied to the Mutex Watershed algorithm (\algname{} with AbsMax linkage), which is clearly not weight-shift invariant (see again counter-example in \TODO{FIG}).
\end{proof}
