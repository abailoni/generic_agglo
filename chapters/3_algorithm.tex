...
\begin{table*}
    ...
    \begin{subtable}[t!]{\textwidth}\centering
        \begin{tabular}{c r  l ?? c | c | c}
            ...
            % \midrule \midrule
            \multirow{5}{*}[-1.5em]{\begin{turn}{90}\thead{\textbf{Linkage criteria} $\,\,\interact(S_u ,S_v)$}\end{turn}}  & Sum: & $\displaystyle \sum_{e\in E_{uv}} \cost_e$ & \thead{Sum Linkage\\Hier. Aggl. Clust.} & \thead{GAEC \cite{keuper2015efficient}} & \thead{Greedy Fixation\\\cite{levinkov2017comparative}} \\ 
            \cmidrule[0.07em]{2-6}
