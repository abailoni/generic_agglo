...
First, we define the graph notation in Sec. \ref{sec:notation}, then we introduce the generalized algorithm in Sec. \ref{sec:algorithm} and finally we show \UPDATE{how it can be seen as a generalization of existing and new graph clustering algorithms (Sec. \ref{sec:alg_update_rules}).}
