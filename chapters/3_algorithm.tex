...
\begin{itemize}
\item In this section we will list some of the algorithms that can be described using the generalized algorithm we presented and define some new ones
\item In Table 1 we collected the update rules we tested and compared in this article (correspond to the simplest and cheapest ones to compute). Later we will mention more of them that were proposed in the literature.
