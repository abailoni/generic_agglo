...
In Appendix \ref{sec:detailed_impl} we comment on the algorithm \UPDATE{computational complexity $\mathcal{O}(N^2 \log N)$} and present an efficient implementation based on an edge contraction algorithm combined with a priority queue.
