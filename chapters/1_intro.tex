...
Our experiments show that the choice of a linkage criteria strongly influence the way how clusters are grown by the agglomerative algorithms, making some linkage methods more suited for certain types of clustering problems.
