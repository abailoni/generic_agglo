...
Finally, \UPDATE{we test these different agglomerative clustering algorithms} on the task of instance segmentation both on the CREMI neuron segmentation challenge and the Cityscapes dataset, by comparing achieved scores, efficiency and robustness to noisy edge weights. \TODO{Add chapters description} 
