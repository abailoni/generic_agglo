...
In Sec. \ref{sec:spectral_clust}, we also show how \algname{} outperforms spectral clustering methods for signed graphs by testing it on synthetic graphs and neuron segmentation.
