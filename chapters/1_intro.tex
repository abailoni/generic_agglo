...
\begin{table*}[t]
 ...
 % \cmidrule{2-6}
    ...
    Notation: given a signed graph $\mathcal{G}(V,E, w_e)$, we denote as $E_{ij}=(S_i \times S_{j}) \cap E$ the set of edges connecting two clusters $S_i \subseteq V$, $S_j \subseteq V$. } 
