...
We study both theoretical and empirical properties of these combinations and prove which ones of them define an ultrametric on the graph.
...
Lastly, we find that some of the algorithms included in our framework, when combined with the predictions from a CNN model, result in a simple instance segmentation pipeline that achieves state-of-the-art performances on the competitive CREMI 2016 EM segmentation benchmark.
