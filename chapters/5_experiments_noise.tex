...
\centering
    ...
    \end{subfigure}
\caption{\UPDATE{Rand-Scores achieved by the generalized algorithm and different update rules when noise is added to the edge weights. Solid lines represent median values; values between the 25th and the 75th percentile are shown in shade areas. In the plots at the top, long-range connections are not used.}}\label{fig:noise_plots}
\end{figure}
