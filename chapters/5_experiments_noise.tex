...
% \begin{table}
    ...
    % \begin{subtable}[t!]{0.5\textwidth}\centering
        ...
        % & \multicolumn{2}{c}{\thead{Add Cannot-Link Constraints:}} \\
         ...
         & \makecell[l]{\algname{}\\ Linkage} & \makecell{Rand-Score \\(higher is better)} \\ \midrule 
...
% DTWS  & -& 0.010 $\pm$ 0.003\\
        \end{tabular}
    \captionof{table}{Rand-Scores achieved by different post-processing methods on CREMI challenge training predictions}
