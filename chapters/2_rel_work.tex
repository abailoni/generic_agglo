...
This work reformulates the clustering algorithms of \cite{levinkov2017comparative,wolf2018mutex,keuper2015efficient} in a generalized framework and adopt ideas from the proposal-free instance segmentation methods \cite{liu2018affinity,wolf2018mutex,lee2017superhuman} to predict long-range affinities between pixels.
